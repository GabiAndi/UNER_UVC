...
#define UVC_UI_FPS				    4		// Tasa de refresco del UI
...
#define UVC_BUZZER_SELECT_TIME		50		// Tiempo del pitido del buzzer encendido apagado
#define UVC_BUZZER_ERROR_TIME		800	    // Tiempo del pitido del buzzer error

#define UVC_OPEN_DOOR_PORT			PORTD	// Puerto para el sensor de puerta cerrada
#define UVC_OPEN_DOOR_PIN			5		// Pin para el sensor de puerta cerrada
